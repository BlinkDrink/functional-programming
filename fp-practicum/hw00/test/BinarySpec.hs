...
isEndSpec :: Spec
isEndSpec = describe "isEnd" do
  it "works on End" do
    isEnd End `shouldBe` True
  it "works on End :. One" do
    isEnd (End :. One) `shouldBe` False
  it "works on End :. Zero" do
    isEnd (End :. Zero) `shouldBe` True
  it "works on End :. Zero :. Zero :. Zero :. One" do
    isEnd (End :. Zero :. Zero :. Zero :. One) `shouldBe` False
  it "works on End :. Zero" do
    isEnd (End :. Zero :. Zero :. Zero :. Zero) `shouldBe` True
...
canonicaliseSpec = describe "canonicalise" do
  ...
  it "works on End :. Zero :. One :. Zero" do
    canonicalise (End :. Zero :. Zero :. Zero :. One :. Zero :. One :. Zero) `shouldBe` End :. One :. Zero :. One :. Zero
